...
const malefica = {
  ...
  villainDeck: [
    ...
    { id: 'mal_o_arc', name: 'Arcolaio', type: 'item', cost: 1,
      effect: 'Se un Eroe viene sconfitto in questo Luogo, ottieni Potere pari alla Forza dell\'Eroe meno 1.' },
    ...
    { id: 'mal_k_tir_1', name: 'Tirannia', type: 'condition', cost: 0,
      effect: 'Durante il turno di un altro giocatore, se ha tre o più Alleati nel Reame, puoi giocare Tirannia. Pesca tre carte, poi scarta tre carte a tua scelta.' },
  ...
  fateDeck: [
    ...
    { id: 'fmal_fauna',    name: 'Fauna',             type: 'hero', strength: 2,
      effect: 'Quando Fauna viene giocata, puoi scartare un Sonno Senza Sogni dal suo Luogo.' },
    ...
    { id: 'fmal_uberto',   name: 'Re Uberto',         type: 'hero', strength: 3,
      effect: 'Quando Re Uberto viene giocato, puoi muovere un Alleato da ogni Luogo adiacente al suo Luogo.' },
    { id: 'fmal_filippo',  name: 'Principe Filippo',  type: 'hero', strength: 5,
      effect: 'Quando il Principe Filippo viene giocato, puoi scartare tutti gli Alleati dal suo Luogo.' },
